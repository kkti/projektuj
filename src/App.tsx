...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      {/* CTA (poptávka) — jednoduché a neprůstřelné pozadí */}
      <section
        id="poptavka"
        className="relative isolate overflow-hidden bg-blue-900 bg-gradient-to-br from-blue-700 to-blue-900"
      >
        <div className="mx-auto max-w-7xl px-6 lg:px-8 py-20">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="text-white drop-shadow-[0_1px_1px_rgba(0,0,0,0.35)]">
              ...
              <p className="mt-3">
                Pošlete nám podklady (pozemek, studie, požadavky). Ozveme se s návrhem postupu.
              </p>
