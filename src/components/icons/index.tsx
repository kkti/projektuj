...
export const ReferenceThumb = () => (
  <svg viewBox="0 0 640 360" className="h-40 w-full" aria-hidden="true">
    <defs>
...
export const IconTenderDocs = () => (
  <svg viewBox="0 0 80 80" className="h-12 w-12" aria-hidden="true">
    <path d="M16 28 h20 l6 6 h22 v26 a4 4 0 0 1 -4 4 H20 a4 4 0 0 1 -4 -4 Z" fill="#DBEAFE" stroke="#2563EB" />
